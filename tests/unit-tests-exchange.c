...
static void test_starts_with(){
    ...
    assert_false(starts_with(NULL, NULL));
    assert_false(starts_with("BUY", NULL));
    assert_false(starts_with(NULL, "BUY"));

    assert_true(starts_with("BUY CHEESE 1 1 1;", "BUY"));
    assert_true(starts_with("SELL CHEESE 1 1 1;", "SELL"));
    assert_false(starts_with("buy CHEESE 1 1 1;", "BUY"));
    assert_false(starts_with("sell CHEESE 1 1 1;", "BUY"));
    assert_false(starts_with("bUY CHEESE 1 1 1;", "BUY"));
    assert_false(starts_with("SeLL CHEESE 1 1 1;", "BUY"));
}
...
static void test_ends_with(){
    ...
    assert_false(ends_with("hello.t", NULL));
    assert_false(ends_with(NULL, "BUY"));

    assert_true(ends_with("file.txt", ".txt"));
    assert_false(ends_with("filetxt", ".txt"));
    assert_false(starts_with("./trader", ".txt"));
    assert_false(starts_with("cheese.TXT", ".txt"));
...
static void test_add_order_sort(){
    ...
    int out = add_order_sort(order_array, new_order);
...
static void test_add_order_sort_sort(){
    ...
    add_order_sort(sell_orders, sell_order_1);
    add_order_sort(sell_orders, sell_order_2);
    add_order_sort(sell_orders, sell_order_3);
...
void test_del_order(){
    ...
    add_order_sort(orders, new_order_1);
    add_order_sort(orders, new_order_2);
    add_order_sort(orders, new_order_3);
...
void test_get_order(){
    ...
    add_order_sort(orders, new_order);
...
void test_check_valid_order_id(){
    ...
    *(order_1 -> trader) = trader_1;
    add_order_sort(trader_1 -> buy_orders, order_1);
    ...
    *(order_2 -> trader) = trader_1;
    add_order_sort(trader_1 -> buy_orders, order_2);
    add_order_sort(orders, order_2);
...
void test_match_orders_no_orders(){
    ...
    *(sell_order -> trader) = create_trader(1);
    ...
    // only 1 buy order
    add_order_sort(buy_orders, buy_order);
    assert_false(match_orders(buy_orders, sell_orders, 0, &exchange_fees));
    ...
    add_order_sort(sell_orders, sell_order);
    assert_false(match_orders(buy_orders, sell_orders, 0, &exchange_fees));
...
void test_match_orders_simple_exact_match(){
    ...
    *(sell_order -> trader) = seller;
    ...
    add_order_sort(buy_orders, buy_order);
    add_order_sort(sell_orders, sell_order);
    add_order_sort(buyer -> buy_orders, buy_order);
    add_order_sort(seller -> sell_orders, sell_order);
...
void test_match_orders_one_buy_multiple_sell_matches(){
    ...
    *(sell_order_3 -> trader) = seller;
    ...
    add_order_sort(sell_orders, sell_order_3);
    add_order_sort(buyer -> buy_orders, buy_order);
    add_order_sort(seller -> sell_orders, sell_order_1);
    add_order_sort(seller -> sell_orders, sell_order_3);
    add_order_sort(seller_2 -> sell_orders, sell_order_2);
...
void test_match_orders_one_seller_multiple_buy_matches(){
    ...
    *(buy_order_4 -> trader) = buyer_4;
    ...
    // only 1 sell order
    add_order_sort(sell_orders, sell_order_1);
    add_order_sort(buy_orders, buy_order_1);
    add_order_sort(buy_orders, buy_order_2);
    add_order_sort(buy_orders, buy_order_3);
    add_order_sort(buy_orders, buy_order_4);

    add_order_sort(seller -> sell_orders, sell_order_1);
    add_order_sort(seller -> buy_orders, buy_order_1); 
    add_order_sort(buyer_2 -> buy_orders, buy_order_2); 
    add_order_sort(buyer_3 -> buy_orders, buy_order_3); 
    add_order_sort(buyer_4 -> buy_orders, buy_order_4); 
...
void test_get_sell_price_levels(){
    ...
    add_order_sort(sell_orders, sell_order_2);
    add_order_sort(sell_orders, sell_order_3);
    add_order_sort(sell_orders, sell_order_4);
    add_order_sort(sell_orders, sell_order_5);
...
void test_get_buy_price_levels(){
    ...
    add_order_sort(buy_orders, buy_order_3);
    add_order_sort(buy_orders, buy_order_4);
    add_order_sort(buy_orders, buy_order_5);
...
int main(void) {
    ...
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_add_order_sort_sort),
        ...
        cmocka_unit_test(test_ends_with)
