...
int interpret_exchange_message(char buffer[BUFFER_SIZE], int write_fd, int read_fd){
    ...
    if (done){
        sleep(2);
        place_sell_order(2, "Water", 5000, 1, write_fd);
        sleep(2);
        disconnect_trader(write_fd, read_fd);
        return -1;
    } else if (strcmp(buffer, "MARKET OPEN;") == 0){
        sleep(2);
        place_buy_order(-1, "Water", 3, 70, write_fd);
        done = true;
    } else if (starts_with(buffer, "ACCEPTED")){
        sleep(2);
        place_sell_order(1, "Water", 5, 65, write_fd);
        done = true;
    }
...
int send_exchange_message(int* order_no, int write_fd, int read_fd){
    ...
    switch(*order_no)
    {
        ...
        case 1:
            sleep(1);
            place_buy_order(1000000, "WATER", 10, 10, write_fd);
            sleep(1);
            break;

        case 2:
            sleep(1);
            place_buy_order(-1, "WATER", 10, 10, write_fd);
            sleep(1);
            break;
        ...
        case 3:
            sleep(1);
            place_buy_order(0, "CHEESE CHEESE CHEESE CHEESE", 10, 10, write_fd);
            sleep(1);
            break;

        case 4:
            sleep(1);
            place_buy_order(0, "waTER", 10, 10, write_fd);
            sleep(1);
            break;
            
        case 5:
            sleep(1);
            place_buy_order(0, "WATERMELON", 10, 10, write_fd);
            sleep(1);
            break;
        ...
        case 7:
            sleep(1);
            place_buy_order(0, "WATER", -1, 10, write_fd);
            sleep(1);
            break;

        case 8:
            sleep(1);
            place_buy_order(0, "WATER", 0, 10, write_fd);
            sleep(1);
            break;

        case 9:
            sleep(1);
            place_buy_order(0, "WATER", 1000000, 10, write_fd);
            sleep(1);
            break;
        ...
        case 10:
            sleep(1);
            place_buy_order(0, "WATER", 10, -1, write_fd);
            sleep(1);
            break;

        case 11:
            sleep(1);
            place_buy_order(0, "WATER", 10, 0, write_fd);
            sleep(1);
            break;

        case 12:
            sleep(1);
            place_buy_order(0, "WATER", 10, 1000000, write_fd);
            sleep(1);
            break;
        ...
        case 14:
            sleep(1);
            place_buy_order(2, "WATER", 29, 14, write_fd);
            sleep(1);
            break;
        ...
        case 15:
            sleep(1);
            place_buy_order(1, "WATER", 20, 15, write_fd);
            sleep(1);
            break;
        ...
        case 17:
            sleep(1);
            place_buy_order(2, "WATER", 100, 12, write_fd);
            sleep(1);
            break;
